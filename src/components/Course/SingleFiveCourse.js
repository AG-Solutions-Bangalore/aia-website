      ...
      return (
        <div className={itemClass ? itemClass : 'it-course-item ed-course-style-2'}>
          ...
          height:"13rem"
            ...
            <span className='px-2'>
            <ul >
              <li>60+ Hours of Video Lectures</li>
              <li>Practice Questions</li>
              <li>Live Doubt Taking Sessions</li>
              <li>Customized Study Notes</li>
             </ul>
            </span>
            </div>
...
export default SingleFiveCourse