      ...
      return (
        <div className={itemClass ? itemClass : 'it-course-item ed-course-style-2'}>
          ...
          height:"20rem"
             ...
             <span>
             A chance to become a Certified Internal Auditor by appearing in a single exam. Members from 18 qualified bodies are eligible for the challenge exam only. It includes content not covered in the curriculum of the qualified bodies exam.</span>
            </div>
...
export default SingleThreeCourse