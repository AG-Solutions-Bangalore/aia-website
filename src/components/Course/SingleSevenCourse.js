      ...
      return (
        <div className={itemClass ? itemClass : 'it-course-item ed-course-style-2'}>
          ...
          height:"13rem"
            ...
            <span className='px-2'>
            <ul >
              <li>50+ Hours of Recorded Video Lectures</li>
              <li>2200+ Practice Questions</li>
              <li>Online Live Revision Classes</li>
              <li>Classes Exam Oriented Study Material</li>
             </ul>
            </span>
            </div>
...
export default SingleSevenCourse