      ...
      return (
        <div className={itemClass ? itemClass : 'it-course-item ed-course-style-2'}>
          ...
          height:"13rem"
            ...
            <span className='px-2'>
            <ul >
              <li>30+ Hours of Recorded/Live Video Lecture</li>
              <li>700+ Practice Questions</li>
              <li>Exam Oriented Study Material</li>
              <li>CAMS Mock Test</li>
             </ul>
            </span>
            </div>
...
export default SingleEightCourse