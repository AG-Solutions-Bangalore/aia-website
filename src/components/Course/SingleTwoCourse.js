    ...
    const {
      ...
      return (
        ...
        className="it-course-info pb-15 mb-30 d-flex justify-content-between">
             <span>
             A platform for Internal Audit professionals to accelerate their professional career. CIA is a three-level exam starting from fundamentals of internal audit and moves towards excellence in practice of Internal Auditing.</span>
            </div>
...
export default SingleTwoCourse