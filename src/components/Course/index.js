    ...
    <div className={itemClass ? itemClass : 'it-course-item ed-course-style-2'}>
      ...
      <div className="it-course-content p-relative">
        ...
        <div style={{
         ...
         <span>
         CFE is a globally recognized certification in the field of fraud prevention, detection, and deterrence. By obtaining a CFE title you can explore growth in your career in the fields of audit, investigation, compliance, security etc.</span>
        </div>
