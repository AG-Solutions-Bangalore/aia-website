...
import Retina from "../../assets/img/logo/retina_logos.png";
    ...
    <>
      ...
      <header className={headerClass ? headerClass : "it-header-height"}>
        <div className="ed-header-top-5-area ed-header-top-5-bg fix">
          <div className=" container-2 mx-4">
            <div className="row">
              <div className="col-xl-6 d-none d-xl-block">
                <div className="ed-header-top-5-social">
                  ...
                  {/* //linkedin */}
                  <a
                    href="https://www.linkedin.com/company/academy-of-internal-audit/"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <svg
                  ...
                  >
                    ...
                    >
                      <path
                        d="M23 2.9999C22.0424 3.67534 20.9821 4.19212 19.86 4.5299C19.2577 3.83784 18.4573 3.34665 17.567 3.12389C16.6767 2.90114 15.7395 2.95528 14.8821 3.27819C14.0247 3.6011 13.2884 4.17599 12.773 4.92986C12.2575 5.68373 11.9877 6.5834 12 7.4999V8.5299C10.2426 8.57538 8.50127 8.18598 6.93101 7.39545C5.36074 6.60491 4.01032 5.43851 3 3.9999C3 3.9999 -1 13.9999 8 17.9999C5.94053 19.3988 3.48716 20.0997 1 19.9999C10 24.9999 21 19.9999 21 7.4999C20.9991 7.22127 20.9723 6.94324 20.92 6.6699C21.9406 5.6633 22.6608 4.39218 23 2.9999Z"
                        fill="currentcolor"
                      />
                    </svg>
                  </a>
                  ...
                  >
                    ...
                    >
                      <path
                        d="M12 0C5.372 0 0 5.372 0 12c0 4.99 3.066 9.262 7.388 11.046-.104-.941-.198-2.386.04-3.416.218-.949 1.404-6.038 1.404-6.038s-.358-.716-.358-1.775c0-1.663.964-2.902 2.163-2.902 1.021 0 1.514.766 1.514 1.685 0 1.027-.653 2.563-.99 3.989-.282 1.184.597 2.15 1.772 2.15 2.123 0 3.759-2.237 3.759-5.462 0-2.858-2.053-4.857-4.985-4.857-3.397 0-5.395 2.553-5.395 5.192 0 1.031.396 2.137.89 2.738.099.121.113.226.084.35-.091.386-.294 1.184-.333 1.35-.052.216-.172.262-.396.157-1.477-.687-2.397-2.847-2.397-4.578 0-3.739 2.719-7.173 7.84-7.173 4.116 0 7.318 2.938 7.318 6.854 0 4.092-2.58 7.385-6.168 7.385-1.202 0-2.334-.623-2.724-1.357l-.741 2.822c-.265 1.024-.986 2.305-1.469 3.085 1.105.334 2.276.516 3.493.516 6.628 0 12-5.372 12-12S18.628 0 12 0z"
                        fill="currentColor"
                      />
                    </svg>
                  </a>
              ...
              <div className="col-xl-6 col-lg-6 col-md-6 col-sm-4">
                <div className="ed-header-top-5-contact text-center text-sm-end">
                  <ul>
                    <li className="d-none d-lg-inline-block">
                      <i>
                        <img src={phoneSVG} alt="" />
                      </i>
                      <a href="tel:+919311320114">+91 93113 20114</a>
                    </li>
                    <li>
                      <i>
                        <img src={mailSVG} alt="" />
              ...
              <div className="row align-items-center">
                <div className="col-xl-2 col-lg-6 col-md-6 col-6">
                  <div className="ed-header-5-logo">
                    <Link to="/">
                      <img src={headerLogo ? headerLogo : Retina} alt="" />
                    </Link>
                  </div>
                </div>
